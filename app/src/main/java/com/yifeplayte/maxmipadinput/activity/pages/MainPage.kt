...
class MainPage : BasePage() {
    override fun onCreate() {
        if (Build.VERSION.SDK_INT <= Build.VERSION_CODES.R) {
            ...
            // Meta 键相关功能 - Android 11
            TextSummaryWithSwitch(
                TextSummaryV(
                    textId = R.string.restore_meta_key_android11,
                    tipsId = R.string.restore_meta_key_android11_tips
                ),
                SwitchV("restore_meta_key_android11", false)
            )
            TextSummaryWithSwitch(
                TextSummaryV(
                    textId = R.string.disable_alt_tab_android11,
                    tipsId = R.string.disable_alt_tab_android11_tips
                ),
                SwitchV("disable_alt_tab_android11", false)
            )
            TextSummaryWithSwitch(
                TextSummaryV(
                    textId = R.string.disable_command_tab_android11,
                    tipsId = R.string.disable_command_tab_android11_tips
                ),
                SwitchV("disable_command_tab_android11", false)
            )
            return
        }
        ...
        // Meta 键相关功能 - Android 12+
        TextSummaryWithSwitch(
            TextSummaryV(
                textId = R.string.restore_meta_key_android12,
                tipsId = R.string.restore_meta_key_android12_tips
            ),
            SwitchV("restore_meta_key_android12", false)
        )
        TextSummaryWithSwitch(
            TextSummaryV(
                textId = R.string.disable_alt_tab_android12,
                tipsId = R.string.disable_alt_tab_android12_tips
            ),
            SwitchV("disable_alt_tab_android12", false)
        )
